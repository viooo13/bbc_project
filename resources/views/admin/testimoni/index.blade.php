...
<head>
    ...
    <title>Admin BBC - Testimoni Influencer</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .data-table td:nth-child(1)::before { content: "Thumbnail"; }
            .data-table td:nth-child(2)::before { content: "Nama Influencer / Media"; }
            .data-table td:nth-child(3)::before { content: "URL YouTube"; }
            .data-table td:nth-child(4)::before { content: "Urutan"; }
    ...
    <main class="main-content">
        <header class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.testimoni.influencer.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Tambah Influencer
                </a>
            </div>
        </header>
        ...
        <section class="card">
            <form class="filter-bar" method="GET" action="{{ route('admin.testimoni.index') }}">
                <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari nama influencer...">
                <button class="btn btn-primary" type="submit"><i class="fas fa-search"></i> Terapkan</button>
                <a class="btn btn-secondary" href="{{ route('admin.testimoni.index') }}"><i class="fas fa-rotate-left"></i> Reset</a>
            </form>
                ...
                <table class="data-table">
                    ...
                    @forelse($influencerTestimonials as $item)
                        <tr>
                            ...
                            <td>
                                <strong style="color:var(--text);">{{ $item->title ?: 'Tanpa Nama' }}</strong>
                            </td>
                            <td>
                                <a href="{{ $item->youtube_url }}" target="_blank" rel="noopener" class="youtube-link">{{ $item->youtube_url }}</a>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="text-align:center;color:var(--text-secondary);padding:24px;">Belum ada testimoni influencer.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
            ...
            {{ $influencerTestimonials->links('pagination::bootstrap-4') }}
        </section>
