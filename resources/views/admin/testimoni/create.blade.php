        ...
        <main class="main-content">
            <div class="form-card">
                <div class="form-header">
                    ...
                    <h1 class="form-title">Tambah Testimoni Influencer</h1>
                </div>
                        ...
                        <div class="left-col">
                            ...
                            <div class="form-group" style="margin-top:30px;">
                                <label class="checkbox-label" style="display:flex; align-items:center; gap:10px; font-weight:500; cursor:pointer;">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:#8B0000; margin:0;">
                                    Aktif Ditampilkan
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="right-col">
                            <div class="form-group">
                                ...
                                <div id="imagePreview" style="margin-top:16px; width: 100%; border-radius:8px; overflow:hidden; border:1px solid #e2e8f0; background:#f8fafc; min-height:160px; display:flex; align-items:center; justify-content:center;">
                                    <img id="youtube_thumb_preview" alt="Preview thumbnail YouTube" style="width:100%; height:auto; display:none;">
                                </div>
                            </div>
