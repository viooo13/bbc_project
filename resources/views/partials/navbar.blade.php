...
<header class="bg-[#3b1b16] text-white sticky top-0 z-50">
    <div class="max-w-7xl mx-auto flex items-center px-6 py-3">
        <div class="flex items-center gap-3">
            <img src="/logo.jpeg" alt="logo" class="w-12 h-12 object-contain rounded" />
        ...
        <nav class="flex-1">
            <ul class="hidden md:flex justify-center gap-8 text-sm font-semibold">
                <li>
                    <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'text-red-400 underline' : 'hover:underline' }}">HOME</a>
                </li>
                <li>
                    <a href="{{ route('pages.tentang') }}" class="{{ request()->routeIs('pages.tentang') ? 'text-red-400 underline' : 'hover:underline' }}">TENTANG BBC</a>
                </li>
                <li>
                    <a href="{{ route('menu.public') }}" class="{{ request()->routeIs('menu.public') ? 'text-red-400 underline' : 'hover:underline' }}">MENU</a>
                </li>
                <li>
                    <a href="{{ route('pages.lokasi_kontak') }}" class="{{ request()->routeIs('pages.lokasi_kontak') ? 'text-red-400 underline' : 'hover:underline' }}">LOKASI DAN KONTAK</a>
                </li>
            </ul>
        </nav>
