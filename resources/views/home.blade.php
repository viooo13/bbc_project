...
<head>
    ...
    <title>Bakso Bunderan Cioma2s</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&amp;family=Plus+Jakarta+Sans:wght@400;500;600;700;800&amp;family=Inter+Display:wght@300;400;500;600;700;800&family=Playfair+Display:wght@400;700;900&family=Montserrat:wght@700;800&family=Pinyon+Script&display=swap" rel="stylesheet">
...
<body class="font-poppins bg-[#EFE1D1] text-[#3a2a1a] overflow-x-hidden">
                ...
                <div class="hero-bento-grid fade-in-up" style="animation-delay: 0.2s">
                    ...
                    <div class="bento-bottom-row">
                        ...
                        <div class="bento-rating-card">
                            ...
                            <div class="bento-rating-score">4.7<span class="bento-rating-max">/5</span></div>

                            <div class="bento-rating-count">Dari 2000+ ulasan Google</div>
                        ...
                        <div class="bento-trust-badge">
                            ...
                            <div class="bento-trust-item">
                                ...
                                <div>
                                    ...
                                    <div class="bento-trust-title">5+ Tahun</div>
                            ...
                            @foreach($recommendedItems->take(12) as $item)
                                ...
                                <div class="bg-white rounded-[1.5rem] p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-2 transition-all duration-500 border border-gray-100 flex flex-col h-full relative group w-full">
                                    ...
                                    <div class="flex-grow flex flex-col text-left px-1 mt-1">
                                        ...
                                        <!-- Badge -->
                                        <div class="inline-block bg-red-600/90 backdrop-blur-md text-white text-[9px] font-bold px-3 py-1.5 rounded-full shadow-md uppercase tracking-widest border border-red-500/50 w-fit mb-2">
                                            Rekomendasi
                                        </div>
    ...
    <div id="addToCartModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
        ...
        <div class="bg-[#EFE1D1] rounded-2xl p-6 w-full max-w-md mx-4">
    ...
    <script>
        ...
        function addToCartFromPackage(paketName) {

            packageName = paketName;

            orderData.nama = paketName;
        ...
        function addToCartByName(itemName) {

            console.log('addToCartByName:', itemName);
        ...
        function addToCart(menuItemId) {
            ...
            console.log('addToCart called with menuItemId:', menuItemId);
            ...
            console.log('Opening add to cart modal');
        ...
        function pesanDirect() {
            ...
            // Tambahkan semua item paket ke keranjang

            const packageItems = [

                {name: 'Bakso Urat Special', quantity: 10},

                {name: 'Mie Ayam Kampung', quantity: 5},

                {name: 'Es Teh Manis', quantity: 10},

                {name: 'Sambal & Kerupuk', quantity: 5},

                {name: 'Alat Makan Lengkap', quantity: 1}
            ...
            console.log('Showing notification for:', packageName);

            showNotification(`Paket ${orderData.nama} berhasil ditambahkan ke keranjang!`, 'success');
        ...
        if (modalOrderEl) {
            ...
            modalOrderEl.addEventListener('click', function(e) {
        ...
        imgs.forEach(img => {
            ...
            if (img.classList.contains('no-photo-hover')) return;

            img.classList.add('photo-hover');
